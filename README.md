...
[![unit tests](https://github.com/lightning-auriga/snakemake_unit_tests/actions/workflows/cicd.yml/badge.svg)](https://github.com/lightning-auriga/snakemake_unit_tests/actions/workflows/cicd.yml)
...
- **`snakemake_unit_tests` `inst/` Directory Location**
  ...
  - notes: this directory contains infrastructure files for [pytest](https://docs.pytest.org/en/stable/)
	...
	`$CONDA_PREFIX/share/snakemake_unit_tests/inst`; otherwise, the path to the GitHub repo
